...
const initialMessages: Message[] = [
  ...
  },
  {
    ...
    role: "assistant",
    content:
      "Bir dizi köşeli parantezlerle tanımlanır: const dizi = [1, 2, 3, 4];",
    timestamp: new Date().toISOString(),
  },
  {
    id: "11",
  ...
  },
  {
    ...
    role: "assistant",
    content:
      "Bir dizinin uzunluğunu .length özelliği ile öğrenebilirsin: dizi.length",
    timestamp: new Date().toISOString(),
  },
  {
    id: "13",
  ...
  },
  {
    ...
    role: "assistant",
    content:
      'Nesne süslü parantezlerle tanımlanır: const kisi = { ad: "Ali", yas: 25 };',
    timestamp: new Date().toISOString(),
  },
];
